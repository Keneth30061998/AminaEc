...
class AdminCoachSchedulePage extends StatelessWidget {
  final con = Get.put(AdminCoachScheduleController());
            ...
            child: Column(
              children: [
                ...
                Obx(() {
                  ...
                  return Column(
                    children: con.filteredCoaches.map((coach) => _coachCard(coach)).toList(),
                  );
                }),
              ],
            ),
  ...
  Widget _coachCard(Coach coach) {
    final schedules = coach.schedules.where((s) {
      ...
      return date != null && date.year == d.year && date.month == d.month && date.day == d.day;
    }).toList()
