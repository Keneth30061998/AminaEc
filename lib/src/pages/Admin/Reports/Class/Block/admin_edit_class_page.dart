import 'package:amina_ec/src/pages/Admin/Reports/Class/admin_edit_class_controller.dart';
...
class AdminCoachBlockPage extends StatelessWidget {
  ...
  Widget _bigCoachBox() {
    return Container(
      ...
      child: const Center(child: Text("Coach", style: TextStyle(fontWeight: FontWeight.bold))),
    );
  }
      ...
      child: Column(
        children: [
          ElevatedButton(
            ...
            style: ElevatedButton.styleFrom(backgroundColor: almostBlack, minimumSize: const Size(double.infinity, 48)),
